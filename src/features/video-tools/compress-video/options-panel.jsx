...
const LEVELS = [
  { value: "low", label: "Maximum compression", desc: "Smallest file, lower quality" },
  { value: "medium", label: "Recommended", desc: "Good balance of size and quality" },
  { value: "high", label: "Best quality", desc: "Larger file, closest to original" },
];

export function CompressVideoOptionsPanel({ options, setOptions }) {
        ...
        {LEVELS.map((l) => (
          <button
            ...
            className={cn(
              ...
              level === l.value ? "border-accent bg-accent-tint" : "border-border bg-secondary/30 hover:border-accent/40"
            )}
          >
