...
import { HiBars3, HiOutlineFilm } from "react-icons/hi2";

import { formatBytes } from "@/lib/validation/validate-file";
import { Card } from "@/components/ui/card";

export function MergeVideosOptionsPanel({ files, options, setOptions }) {
  ...
  return (
    <Card className="p-4">
      ...
      <p className="mt-3 text-xs text-muted-foreground">
        Clips in different formats, resolutions, or frame rates are automatically matched to a common
        size and frame rate before merging, so mixed sources merge correctly.
      </p>
    </Card>
  );
}
