...
export function VideoSpeedChangerOptionsPanel({ options, setOptions }) {
  ...
  return (
    <Card className="space-y-4 p-5">
      ...
      <p className="text-xs text-muted-foreground">
        Both video and audio speed change together, in sync — audio pitch stays natural at any speed,
        not higher or lower.
      </p>
    </Card>
  );
